package com.jcohy.pay.http;


import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONException;
import com.jcohy.pay.enums.MethodType;
import com.jcohy.pay.expection.PayErrorException;
import com.jcohy.pay.expection.PayException;
import com.jcohy.pay.utils.StringUtils;
import com.jcohy.pay.utils.XMLUtils;
...
import static com.jcohy.pay.http.UriVariables.getMapToParameters;
...
/*            String charset = "UTF-8";
            ...
            if (isXml(contentType[0], first)) {
                try {
                    return XMLUtils.toJSONObject(result, getDefaultCharset()).toJavaObject(responseType);
                }catch (Exception e){
                    ;
                }
            }
